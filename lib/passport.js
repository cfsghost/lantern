...
module.exports = {
	...
	facebook: function(passport) {
		...
		passport.use(new FacebookStrategy({
				...
				callbackURL: protocol + settings.general.server.external_host + port + '/auth/facebook/callback',
	...
	google: function(passport) {
		...
		passport.use(new GoogleStrategy({
				...
				callbackURL: protocol + settings.general.server.external_host + port + '/auth/google/callback'
			},
			function(accessToken, refreshToken, profile, done) {
	...
	linkedin: function(passport) {
		...
		passport.use(new LinkedinStrategy({
				...
				callbackURL: protocol + settings.general.server.external_host + port + '/auth/linkedin/callback',
